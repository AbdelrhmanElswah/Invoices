            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">Bill No.</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option value="" selected disabled>Select The Precentage Of The Tax</option>
                        ...
                        <p class="text-danger">*attachment pdf, jpeg ,.jpg , png </p>
    ...
    <script>
        function myFunction() {
            ...
            if (typeof Amount_Commission === 'undefined' || !Amount_Commission) {
                ...
                alert('Please, Enter Amount_Commission Field  ');
